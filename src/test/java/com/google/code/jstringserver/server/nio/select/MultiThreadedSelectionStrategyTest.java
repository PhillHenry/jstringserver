...
public class MultiThreadedSelectionStrategyTest {
    ...
    private MultiThreadedSelectionStrategy toTest;

    @Before
    public void startServer() throws IOException {
        serverBuilder = new ServerBuilder(10);
        serverSelector = Selector.open();
        toTest = new MultiThreadedSelectionStrategy(null, serverSelector, writer, reader, executorService);
    }
